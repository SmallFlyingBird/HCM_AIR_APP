...
typedef union
{
	...
	struct{
		...
		uint8 HCML2DTCGroup1Bit6_LR_Detection      :1;//Headlamp Control Module Left/Right Detection  General electrical failure
		...
		uint8 HCML2DTCGroup3Bit4_SideDetection     :1;//Side Detection Inconsistency  Component Failures
