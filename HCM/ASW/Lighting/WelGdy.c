...
uint8 Interface_GetChannelID1_Tap_Pwm(void)
{
    return ChannelID1_Tap_Pwm;
}
/* **********************************************CH2 GROUP3*********************************************************** */
