...
uint16_t Get_LightN_1(Light_Functions lightfunc)
{
	uint8 N_1FuncOpen = 0;
	N_1FuncOpen = (ParaMgr_LightN_1_W>>lightfunc)&0x01;
	return N_1FuncOpen;
}
...
uint16_t Get_VehicleW(void)
{
	return ParaMgr_Vehicle_W;
}
/*return voltage*10v  */
