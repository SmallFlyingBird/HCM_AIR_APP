    ...
    for (i = 0; i < CHANNEL_SIZE; i++)
    {
        ...
        case E_HSChannel_HS0:
            ...
            if (HSChannelDiagInfo.bits.Short2GND == 1)
            {
                ...
                Interface_SetD900Data( HSD1_SCG , STATE_ERROR);
            }
            else
            {
                ...
                Interface_SetD900Data( HSD1_SCG , STATE_OK);
            }
            ...
            if (HSChannelDiagInfo.bits.OpenOrShort2Vcc == 1)
            {
                ...
                Interface_SetD900Data(HSD1_SCB_OL , STATE_ERROR);
            }
            else
            {
                ...
                Interface_SetD900Data(HSD1_SCB_OL , STATE_OK);
            }
            break;
        case E_HSChannel_HS1:
            if (Interface_GetHSChannelDiagInfo(E_HSChannel_HS1) == 2)
            {
                ...
                {
                    Interface_SetDtcHSDAndFanError((E_HSDAndDCMotorErrorType_HSD1_OverCur + (i - E_HSChannel_HS1) * 3), 1);
                }
            }
            else
            {
                ...
                {
                    Interface_SetDtcHSDAndFanError((E_HSDAndDCMotorErrorType_HSD1_OverCur + (i - E_HSChannel_HS1) * 3), 0);
                }
            }
            ...
            if (Interface_GetHSChannelDiagInfo(E_HSChannel_HS1) == 1)
            {
                ...
                {
                    Interface_SetDtcHSDAndFanError((E_HSDAndDCMotorErrorType_HSD1_Shor2Gnd + (i - E_HSChannel_HS1) * 3), 1);
                    Interface_SetD900Data( HSD2_SCG , STATE_ERROR);
                }
            }
            else
            {
                ...
                {
                    Interface_SetDtcHSDAndFanError((E_HSDAndDCMotorErrorType_HSD1_Shor2Gnd + (i - E_HSChannel_HS1) * 3), 0);
                    Interface_SetD900Data( HSD2_SCG , STATE_OK);
                }
            }
/* HS1只配置直流电机，HSD的开路和电机控制线的开路是一样的 */
            break;
        }
    }
    return rtval;
