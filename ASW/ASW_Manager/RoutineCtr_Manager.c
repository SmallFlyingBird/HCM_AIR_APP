...
Std_ReturnType ASW_StartRoutine_LevelingMotorReferenceRun(const uint8_t *InBuffer, uint8_t *OutBuffer)
{
    ...
    rtval = LevelingMotor_StartRoutineCtr_RefernceMove(InBuffer, OutBuffer);
...
Std_ReturnType ASW_StopRoutine_LevelingMotorReferenceRun(const uint8_t *InBuffer, uint8_t *OutBuffer)
{
    ...
    rtval = LevelingMotor_StopRoutineCtr_RefernceMove(InBuffer, OutBuffer);
...
Std_ReturnType ASW_RequestRoutineResult_LevelingMotorReferenceRun(const uint8_t *InBuffer, uint8_t *OutBuffer)
{
    ...
    rtval = LevelingMotor_RequestRoutineResult_RefernceMove(InBuffer, OutBuffer);
...
Std_ReturnType ASW_StartRoutine_SwivelingMotorReferenceRun(const uint8_t *InBuffer, uint8_t *OutBuffer)
{
    ...
    rtval = SwivelingMotor_StartRoutineCtr_RefernceMove(InBuffer, OutBuffer);
...
Std_ReturnType ASW_StopRoutine_SwivelingMotorReferenceRun(const uint8_t *InBuffer, uint8_t *OutBuffer)
{
    ...
    rtval = SwivelingMotor_StopRoutineCtr_RefernceMove(InBuffer, OutBuffer);
...
Std_ReturnType ASW_RequestRoutineResult_SwivelingMotorReferenceRun(const uint8_t *InBuffer, uint8_t *OutBuffer)
{
    ...
    rtval = SwivelingMotor_RequestRoutineResult_RefernceMove(InBuffer, OutBuffer);
...
{
    Std_ReturnType rtval = E_OK;
    rtval = LevelingMotor_StartRoutineCtr_MotorMove(InBuffer, OutBuffer);
    return rtval;
}
...
{
    Std_ReturnType rtval = E_OK;
    rtval = LevelingMotor_StopRoutineCtr_MotorMove(InBuffer, OutBuffer);
    return rtval;
}
...
{
    Std_ReturnType rtval = E_OK;
    rtval = LevelingMotor_RequestRoutineResult_MotorMove(InBuffer, OutBuffer);
    return rtval;
}
...
{
    Std_ReturnType rtval = E_OK;
    rtval = SwivelingMotor_StartRoutineCtr_MotorMove(InBuffer, OutBuffer);
    return rtval;
}
...
{
    Std_ReturnType rtval = E_OK;
    rtval = SwivelingMotor_StopRoutineCtr_MotorMove(InBuffer, OutBuffer);
    return rtval;
}
...
{
    Std_ReturnType rtval = E_OK;
    rtval = SwivelingMotor_RequestRoutineResult_MotorMove(InBuffer, OutBuffer);
    return rtval;
}
