...
void DCMotor_MainFunction(uint8_t timebase)
{
    ...
    Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr, 50u, 0x8000*0.4);

    // switch( Cycle )
    // {
    //     case 0u:
    //         Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr, 50u,0);//0x4899U);//0x1999 约等于20%   //0x3399空载50V
    //         break;
    //     case 100u:
    //         Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr,50u, 0x8000*0.2);
    //         break;
    //     case 200u:
    //         Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr, 50u,0x8000*0.4);
    //         break;
    //     case 300u:
    //         Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr,50u, 0x8000*0.6);
    //         break;
    //     case 400u:
    //         Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr, 50u,0x8000*0.8);
    //         break;
    //     case 500u:
    //         Pwm_SetPeriodAndDuty(PwmConf_PwmChannel_DC_Ctr,50u, 0x8000);
    //         break;
    // }
    // if (Cycle == 0)
    // {
