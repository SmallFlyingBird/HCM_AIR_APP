...
DiDSignalChannel g_DiDSignalChannel[CHANNEL_NUM];
                                /* LB   HB  DRL POS  TI  */    
uint32 DidChannelFunction[5]={0x2,0x8,0x10,0x20,0x40};
...
static void DID_Interface_GetDidSignal(E_ChannelID id)
{
    ...
    g_DiDSignalChannel[id].didsignalchannel_ActualVol=(uint16)(channelvol);
    g_DiDSignalChannel[id].didsignalchannel_ActualFreq      = 0xffff;
