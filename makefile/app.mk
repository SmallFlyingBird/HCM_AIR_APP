...
$(TARGET_NAME).elf : $(OBJ_FILES)
	...
	@$(HEX) $(HEX_DIR_AND_NAME) /FR:0x38000-0x524EF:0x78000-0x78FFD /FP:0xFF /XI:32 -s -o $(HEX_DIR_AND_NAME)
	@$(HEX) $(HEX_DIR_AND_NAME) /FR:0x524F0-0x524FD 	 /FP:0x00078142000781430107FFFFFFFF /XI:32 -s -o $(HEX_DIR_AND_NAME)
	@$(HEX) $(HEX_DIR_AND_NAME) /CR:0x38000-0x524FF /XI:32 -s -o $(HEX_PARA)
