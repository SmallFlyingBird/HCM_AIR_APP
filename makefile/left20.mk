...
#	@$(LD) $(LD_OPT) -T $(LINKER_DEF) $(OBJ_DIR)/*.o -o $(BIN_DIR)/$@ -L$(LIB_PATH) -l$(LIB_NAME)
	...
	@$(HEX) $(HEX_DIR_AND_NAME) /FR:0x38000-0x4FFEF:0x78000-0x78FFF /FP:0xFF /XI:32 -s -o $(HEX_APP_AND_PAR)
	@$(HEX) $(HEX_APP_AND_PAR) /FR:0x4FFF0-0x4FFFF /FP:0x0007813A0007813B0102FFFFFFFFFFFF /XI:32 -s -o $(HEX_APP_AND_PAR)
	$(HEX) /MT:$(HEX_APP_AND_PAR)+$(HEX_BOOT_FILE) /XI:32 -s -o $(HEX_MERGE_DIR)
	@$(HEX) $(HEX_DIR_AND_NAME) /FR:0x4FFF0-0x4FFFF /FP:0x0007813A0007813B0102FFFFFFFFFFFF /XI:32 -s -o $(HEX_DIR_AND_NAME)
vpath %.c $(SRC_DIRS)
vpath %.o $(OBJ_DIR)
