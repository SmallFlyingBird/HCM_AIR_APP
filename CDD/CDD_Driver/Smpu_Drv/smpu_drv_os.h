...
#ifndef SMPU_DRV_OS_H
#define SMPU_DRV_OS_H
...
typedef struct
{
    ...
    SmpuControlState_t  exeAllow;       /*!< Enable/Disable execute access. */
    SmpuControlState_t  writeAllow;     /*!< Enable/Disable write access. */
    SmpuControlState_t  readAllow;      /*!< Enable/Disable read access. */
    SMPU_SupvModeAccess_t supervisorModeAccess;  /*!< Access control for bus master in supervisor mode.*/
} SMPU_Config_t;
...
typedef struct
{
    SmpuFlagStatus_t write;                 /*!< whether slave port is caused by writing operation 
