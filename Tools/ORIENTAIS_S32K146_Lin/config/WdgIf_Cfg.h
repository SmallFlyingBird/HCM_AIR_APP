...
#define WdgIf_SetTriggerCondition_Map(timeout)          TLE9263_SetTriggerCondition(timeout)
#define WdgIf_SetMode_Map(mode)                         TLE9263_SetMode(mode)
