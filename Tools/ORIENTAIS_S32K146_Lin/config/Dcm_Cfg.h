...
#define  DCM_CHANNEL_LENGTH                 		(512u)   /*the total length of channel*/
...
#define  DCM_UDS_SERVICE0X19_04_ENABLED				(STD_OFF)
...
#define  DCM_DSP_ROUTINE_MAX_NUM            		(1u)       		/*Number of RoutineID*/
/**=======================================================**/
