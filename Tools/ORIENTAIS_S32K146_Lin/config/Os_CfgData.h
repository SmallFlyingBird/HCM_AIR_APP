...
#define OS_START_SEC_CODE
#include "Os_MemMap.h" 
DeclareISR(ISR_OS_ADC0_IRQHandler);
DeclareISR(ISR_OS_ADC1_IRQHandler);
DeclareISR(ISR_OS_DMA0_IRQHandler);
DeclareISR(ISR_OS_ERM_double_fault_IRQHandler);
DeclareISR(ISR_OS_ERM_single_fault_IRQHandler);
DeclareISR(ISR_OS_FTFC_Fault_IRQHandler);
DeclareISR(ISR_OS_LPIT0_Ch0_IRQHandler);
DeclareISR(ISR_OS_LPUART0_RxTx_IRQHandler);
DeclareISR(ISR_OS_LPUART1_RxTx_IRQHandler);
DeclareISR(ISR_OS_LVD_LVW_IRQHandler);  
#define OS_STOP_SEC_CODE
#include "Os_MemMap.h" 
