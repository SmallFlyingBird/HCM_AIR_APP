...
SET addrCall=
rem (Required VBF2.6) Specifies the Verification block table start address. Example: VerificationBlockStartAddr=FFFFEEEE
SET VerificationBlockStartAddr=10010000
