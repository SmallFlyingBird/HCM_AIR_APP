...
/* PRQA S 0602,0603,0306,0883,3115 EOF */
...
* PRQA S 0635 Dir 1.1: Any implementation-defined behaviour on which the output of the program depends shall be documented and understood
...
*/
/* PRQA S 0750, 0635, 4700, 0342, 3678, 0878, 0784 EOF */
...
__STATIC_INLINE void __NVIC_SetPriority(IRQn_Type IRQn, uint32 priority)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->IP[((uint32)IRQn)]                = (uint8)((priority << (8U - __NVIC_PRIO_BITS)) & (uint32)0xFFUL);
    }
    else
    {
