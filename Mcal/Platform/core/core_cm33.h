...
/* PRQA S 0602,0603,0306,3115,0883, 0660 EOF */

/*
* @page misra_violations MISRA-C:2012 violations list
* PRQA S 0750 Rule 19.2: The union keyword should not be used.
* PRQA S 0635 Rule 1.2: Language extensions should not be used
* PRQA S 0635 Rule 6.1: Bit-fields shall only be declared with an appropriate type
* PRQA S 0635 Dir 1.1: Any implementation-defined behaviour on which the output of the program depends
*                      shall be documented and understood
* PRQA S 0342 Rule 20.10: The # and ## preprocessor operators should not be used
* PRQA S 3876 Rule-8.13: A pointer should point to a const-qualified type whenever possible
* PRQA S 3116 Dir 1.1: Any implementation-defined behaviour on which the output of the program depends shall be
*                      shall be documented and understood
* PRQA S 0784 Rule 5.5: Identifiers shall be distinct from macro names
*/
/* MR12 RULE 19.2 VIOLATION: The Cortex-M CPU core special registers - APSR, IPSR, xPSR, CONTROL, are defined as unions for
*                            control and configuration access.
*/
/* MR12 RULE 1.2/6.1 and Dir 1.1 VIOLATION: The Cortex-M CPU core special registers - APSR, IPSR, xPSR, CONTROL, are defined as unions
*                                           with bit-filed. The unions and bit-field define are used to provide an efficient way to access
*/
/* MR12 RULE 20.10 VIOLATION: The # and ## preprocessor operators is used to concatenate tokens
*                            in the CMSIS macros to generate the register names and bit-field names.
*/
/* MR12 RULE 8.13 VIOLATION: The IRQ vector fetch from the vector table base register SCB->VTOR, verified with no risk, is not const-qualified. */
/* MR12 Dir 1.1 VIOLATION: #pragma arguments 'GCC diagnostic ignored "-Wpedantic"
*                            This #pragma directive has been ignored Preprocessor, ISO:C90 Language [6.8.6]
*/
/* MR12 Rule 5.5 VIOLATION:  Identifier 'ISR' of IPSR_Type only used in the Cortex-M33 core register operation API,
*                            has no conflict with the ISR macro defined for peripheral ISR(Interrupt Service Routine)
*/
/* PRQA S 0750, 0635, 4700, 0342, 3678, 3116, 0784 EOF */
...
typedef union
{
    struct
    {
        ...
        uint32 SPSEL: 1;                   /*!< bit:      1  Stack-pointer select */
        uint32 FPCA: 1;                    /*!< bit:      2  Floating-point context active */
        uint32 SFPA: 1;                    /*!< bit:      3  Secure floating-point active */
        uint32 _reserved1: 28;             /*!< bit:  4..31  Reserved */
    } b;                                   /*!< Structure used for bit  access */
    uint32 w;                            /*!< Type      used for word access */
} CONTROL_Type;
...
typedef struct
{
    __IOM uint32 ISER[16U];              /*!< Offset: 0x000 (R/W)  Interrupt Set Enable Register */
    uint32 RESERVED0[16U];
    __IOM uint32 ICER[16U];              /*!< Offset: 0x080 (R/W)  Interrupt Clear Enable Register */
    uint32 RSERVED1[16U];
    __IOM uint32 ISPR[16U];              /*!< Offset: 0x100 (R/W)  Interrupt Set Pending Register */
    uint32 RESERVED2[16U];
    __IOM uint32 ICPR[16U];              /*!< Offset: 0x180 (R/W)  Interrupt Clear Pending Register */
    uint32 RESERVED3[16U];
    __IOM uint32 IABR[16U];              /*!< Offset: 0x200 (R/W)  Interrupt Active bit Register */
    uint32 RESERVED4[16U];
    __IOM uint32 ITNS[16U];              /*!< Offset: 0x280 (R/W)  Interrupt Non-Secure State Register */
    uint32 RESERVED5[16U];
    __IOM uint8  IPR[496U];              /*!< Offset: 0x300 (R/W)  Interrupt Priority Register (8Bit wide) */
    uint32 RESERVED6[580U];
...
typedef struct
{
    ...
    __IOM uint8  SHPR[12U];              /*!< Offset: 0x018 (R/W)  System Handlers Priority Registers (4-7, 8-11, 12-15) */
    ...
    __IM  uint32 ID_MMFR[4U];            /*!< Offset: 0x050 (R/ )  Memory Model Feature Register */
    __IM  uint32 ID_ISAR[6U];            /*!< Offset: 0x060 (R/ )  Instruction Set Attributes Register */
    ...
    __IOM uint32 NSACR;                  /*!< Offset: 0x08C (R/W)  Non-Secure Access Control Register */
    uint32 RESERVED7[21U];
    __IOM uint32 SFSR;                   /*!< Offset: 0x0E4 (R/W)  Secure Fault Status Register */
    __IOM uint32 SFAR;                   /*!< Offset: 0x0E8 (R/W)  Secure Fault Address Register */
    uint32 RESERVED3[69U];
...
typedef struct
{
    ...
    __IOM uint32 CPPWR;                  /*!< Offset: 0x00C (R/W)  Coprocessor Power Control  Register */
} SCnSCB_Type;
...
typedef struct
{
    ...
    uint32 RESERVED5[1U];
    __IM  uint32 DEVARCH;                /*!< Offset: 0xFBC (R/ )  ITM Device Architecture Register */
    uint32 RESERVED6[4U];
...
typedef struct
{
    ...
    uint32 RESERVED8[1U];
    __IOM uint32 COMP4;                  /*!< Offset: 0x060 (R/W)  Comparator Register 4 */
    uint32 RESERVED9[1U];
    __IOM uint32 FUNCTION4;              /*!< Offset: 0x068 (R/W)  Function Register 4 */
    uint32 RESERVED10[1U];
    __IOM uint32 COMP5;                  /*!< Offset: 0x070 (R/W)  Comparator Register 5 */
    uint32 RESERVED11[1U];
    __IOM uint32 FUNCTION5;              /*!< Offset: 0x078 (R/W)  Function Register 5 */
    uint32 RESERVED12[1U];
    __IOM uint32 COMP6;                  /*!< Offset: 0x080 (R/W)  Comparator Register 6 */
    uint32 RESERVED13[1U];
    __IOM uint32 FUNCTION6;              /*!< Offset: 0x088 (R/W)  Function Register 6 */
    uint32 RESERVED14[1U];
    __IOM uint32 COMP7;                  /*!< Offset: 0x090 (R/W)  Comparator Register 7 */
    uint32 RESERVED15[1U];
    __IOM uint32 FUNCTION7;              /*!< Offset: 0x098 (R/W)  Function Register 7 */
    uint32 RESERVED16[1U];
    __IOM uint32 COMP8;                  /*!< Offset: 0x0A0 (R/W)  Comparator Register 8 */
    uint32 RESERVED17[1U];
    __IOM uint32 FUNCTION8;              /*!< Offset: 0x0A8 (R/W)  Function Register 8 */
    uint32 RESERVED18[1U];
    __IOM uint32 COMP9;                  /*!< Offset: 0x0B0 (R/W)  Comparator Register 9 */
    uint32 RESERVED19[1U];
    __IOM uint32 FUNCTION9;              /*!< Offset: 0x0B8 (R/W)  Function Register 9 */
    uint32 RESERVED20[1U];
    __IOM uint32 COMP10;                 /*!< Offset: 0x0C0 (R/W)  Comparator Register 10 */
    uint32 RESERVED21[1U];
    __IOM uint32 FUNCTION10;             /*!< Offset: 0x0C8 (R/W)  Function Register 10 */
    uint32 RESERVED22[1U];
    __IOM uint32 COMP11;                 /*!< Offset: 0x0D0 (R/W)  Comparator Register 11 */
    uint32 RESERVED23[1U];
    __IOM uint32 FUNCTION11;             /*!< Offset: 0x0D8 (R/W)  Function Register 11 */
    uint32 RESERVED24[1U];
    __IOM uint32 COMP12;                 /*!< Offset: 0x0E0 (R/W)  Comparator Register 12 */
    uint32 RESERVED25[1U];
    __IOM uint32 FUNCTION12;             /*!< Offset: 0x0E8 (R/W)  Function Register 12 */
    uint32 RESERVED26[1U];
    __IOM uint32 COMP13;                 /*!< Offset: 0x0F0 (R/W)  Comparator Register 13 */
    uint32 RESERVED27[1U];
    __IOM uint32 FUNCTION13;             /*!< Offset: 0x0F8 (R/W)  Function Register 13 */
    uint32 RESERVED28[1U];
    __IOM uint32 COMP14;                 /*!< Offset: 0x100 (R/W)  Comparator Register 14 */
    uint32 RESERVED29[1U];
    __IOM uint32 FUNCTION14;             /*!< Offset: 0x108 (R/W)  Function Register 14 */
    uint32 RESERVED30[1U];
    __IOM uint32 COMP15;                 /*!< Offset: 0x110 (R/W)  Comparator Register 15 */
    uint32 RESERVED31[1U];
    __IOM uint32 FUNCTION15;             /*!< Offset: 0x118 (R/W)  Function Register 15 */
    uint32 RESERVED32[934U];
    __IM  uint32 LSR;                    /*!< Offset: 0xFB4 (R  )  Lock Status Register */
    uint32 RESERVED33[1U];
    __IM  uint32 DEVARCH;                /*!< Offset: 0xFBC (R/ )  Device Architecture Register */
} DWT_Type;
...
typedef struct
{
    ...
    __IOM uint32 PSCR;                   /*!< Offset: 0x308 (R/W)  Periodic Synchronization Control Register */
    uint32 RESERVED3[759U];
    __IM  uint32 TRIGGER;                /*!< Offset: 0xEE8 (R/ )  TRIGGER Register */
    __IM  uint32 ITFTTD0;                /*!< Offset: 0xEEC (R/ )  Integration Test FIFO Test Data 0 Register */
    __IOM uint32 ITATBCTR2;              /*!< Offset: 0xEF0 (R/W)  Integration Test ATB Control Register 2 */
    uint32 RESERVED4[1U];
    __IM  uint32 ITATBCTR0;              /*!< Offset: 0xEF8 (R/ )  Integration Test ATB Control Register 0 */
    __IM  uint32 ITFTTD1;                /*!< Offset: 0xEFC (R/ )  Integration Test FIFO Test Data 1 Register */
    ...
    uint32 RESERVED7[8U];
    __IM  uint32 DEVID;                  /*!< Offset: 0xFC8 (R/ )  Device Configuration Register */
    __IM  uint32 DEVTYPE;                /*!< Offset: 0xFCC (R/ )  Device Type Identifier Register */
} TPI_Type;
...
typedef struct
{
    ...
    __IOM uint32 RNR;                    /*!< Offset: 0x008 (R/W)  MPU Region Number Register */
    __IOM uint32 RBAR;                   /*!< Offset: 0x00C (R/W)  MPU Region Base Address Register */
    __IOM uint32 RLAR;                   /*!< Offset: 0x010 (R/W)  MPU Region Limit Address Register */
    __IOM uint32 RBAR_A1;                /*!< Offset: 0x014 (R/W)  MPU Region Base Address Register Alias 1 */
    __IOM uint32 RLAR_A1;                /*!< Offset: 0x018 (R/W)  MPU Region Limit Address Register Alias 1 */
    __IOM uint32 RBAR_A2;                /*!< Offset: 0x01C (R/W)  MPU Region Base Address Register Alias 2 */
    __IOM uint32 RLAR_A2;                /*!< Offset: 0x020 (R/W)  MPU Region Limit Address Register Alias 2 */
    __IOM uint32 RBAR_A3;                /*!< Offset: 0x024 (R/W)  MPU Region Base Address Register Alias 3 */
    __IOM uint32 RLAR_A3;                /*!< Offset: 0x028 (R/W)  MPU Region Limit Address Register Alias 3 */
    uint32 RESERVED0[1];
    union
    {
        __IOM uint32 MAIR[2];
        struct
        {
            __IOM uint32 MAIR0;                  /*!< Offset: 0x030 (R/W)  MPU Memory Attribute Indirection Register 0 */
            __IOM uint32 MAIR1;                  /*!< Offset: 0x034 (R/W)  MPU Memory Attribute Indirection Register 1 */
        };
    };
} MPU_Type;
...
#define MPU_RBAR_XN_Msk                    (0x01UL /*<< MPU_RBAR_XN_Pos*/)                  /*!< MPU RBAR: XN Mask */
...
typedef struct
{
    __IOM uint32 CTRL;                   /*!< Offset: 0x000 (R/W)  SAU Control Register */
    __IM  uint32 TYPE;                   /*!< Offset: 0x004 (R/ )  SAU Type Register */
#if defined (__SAUREGION_PRESENT) && (__SAUREGION_PRESENT == 1U)
    __IOM uint32 RNR;                    /*!< Offset: 0x008 (R/W)  SAU Region Number Register */
    __IOM uint32 RBAR;                   /*!< Offset: 0x00C (R/W)  SAU Region Base Address Register */
    __IOM uint32 RLAR;                   /*!< Offset: 0x010 (R/W)  SAU Region Limit Address Register */
#else
    uint32 RESERVED0[3];
#endif
    __IOM uint32 SFSR;                   /*!< Offset: 0x014 (R/W)  Secure Fault Status Register */
    __IOM uint32 SFAR;                   /*!< Offset: 0x018 (R/W)  Secure Fault Address Register */
} SAU_Type;
...
typedef struct
{
    ...
    __IM  uint32 MVFR0;                  /*!< Offset: 0x010 (R/ )  Media and VFP Feature Register 0 */
    __IM  uint32 MVFR1;                  /*!< Offset: 0x014 (R/ )  Media and VFP Feature Register 1 */
    __IM  uint32 MVFR2;                  /*!< Offset: 0x018 (R/ )  Media and VFP Feature Register 2 */
} FPU_Type;
...
typedef struct
{
    ...
    uint32 RESERVED0[1U];
    __IOM uint32 DAUTHCTRL;              /*!< Offset: 0x014 (R/W)  Debug Authentication Control Register */
    __IOM uint32 DSCSR;                  /*!< Offset: 0x018 (R/W)  Debug Security Control and Status Register */
} CoreDebug_Type;
...
typedef struct
{
    __OM  uint32 DLAR;                   /*!< Offset: 0x000 ( /W)  SCS Software Lock Access Register */
    __IM  uint32 DLSR;                   /*!< Offset: 0x004 (R/ )  SCS Software Lock Status Register */
    __IM  uint32 DAUTHSTATUS;            /*!< Offset: 0x008 (R/ )  Debug Authentication Status Register */
    __IM  uint32 DDEVARCH;               /*!< Offset: 0x00C (R/ )  SCS Device Architecture Register */
    __IM  uint32 DDEVTYPE;               /*!< Offset: 0x010 (R/ )  SCS Device Type Register */
} DIB_Type;
 ...
 */
__STATIC_INLINE void __NVIC_SetPriorityGrouping(uint32 PriorityGroup)
{
    uint32 reg_value;
 ...
 */
__STATIC_INLINE uint32 __NVIC_GetPriorityGrouping(void)
{
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 __NVIC_GetEnableIRQ(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC->ISER[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
...
__STATIC_INLINE void __NVIC_DisableIRQ(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->ICER[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
        __DSB();
        __ISB();
    }
}
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 __NVIC_GetPendingIRQ(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC->ISPR[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
...
__STATIC_INLINE void __NVIC_SetPendingIRQ(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->ISPR[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
    }
}
...
__STATIC_INLINE void __NVIC_ClearPendingIRQ(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->ICPR[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
    }
}
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 __NVIC_GetActive(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC->IABR[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 NVIC_GetTargetState(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC->ITNS[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 NVIC_SetTargetState(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->ITNS[(((uint32)IRQn) >> 5UL)] |= ((uint32)(1UL << (((uint32)IRQn) & 0x1FUL)));
        return ((uint32)(((NVIC->ITNS[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 NVIC_ClearTargetState(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->ITNS[(((uint32)IRQn) >> 5UL)] &= ~((uint32)(1UL << (((uint32)IRQn) & 0x1FUL)));
 ...
 */
__STATIC_INLINE void __NVIC_SetPriority(IRQn_Type IRQn, uint32 priority)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC->IPR[((uint32)IRQn)]               = (uint8)((priority << (8U - __NVIC_PRIO_BITS)) & (uint32)0xFFUL);
    }
    else
    {
        SCB->SHPR[(((uint32)IRQn) & 0xFUL) - 4UL] = (uint8)((priority << (8U - __NVIC_PRIO_BITS)) & (uint32)0xFFUL);
    }
}
 ...
 */
__STATIC_INLINE uint32 __NVIC_GetPriority(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return (((uint32)NVIC->IPR[((uint32)IRQn)]               >> (8U - __NVIC_PRIO_BITS)));
    }
    else
    {
        return (((uint32)SCB->SHPR[(((uint32)IRQn) & 0xFUL) - 4UL] >> (8U - __NVIC_PRIO_BITS)));
    }
}
 ...
 */
__STATIC_INLINE uint32 NVIC_EncodePriority(uint32 PriorityGroup, uint32 PreemptPriority, uint32 SubPriority)
{
    uint32 PriorityGroupTmp = (PriorityGroup & (uint32)0x07UL);   /* only values 0..7 are used          */
 ...
 */
__STATIC_INLINE void NVIC_DecodePriority(uint32 Priority, uint32 PriorityGroup, uint32 *const pPreemptPriority, uint32 *const pSubPriority)
{
    uint32 PriorityGroupTmp = (PriorityGroup & (uint32)0x07UL);   /* only values 0..7 are used          */
    uint32 PreemptPriorityBits;
    uint32 SubPriorityBits;
 ...
 */
__STATIC_INLINE void __NVIC_SetVector(IRQn_Type IRQn, uint32 vector)
{
 ...
 */
__STATIC_INLINE uint32 __NVIC_GetVector(IRQn_Type IRQn)
{
    uint32 *vectors = (uint32 *)SCB->VTOR;
...
/**
  ...
  \param [in]      PriorityGroup  Priority grouping field.
 */
__STATIC_INLINE void TZ_NVIC_SetPriorityGrouping_NS(uint32 PriorityGroup)
{
    uint32 reg_value;
    uint32 PriorityGroupTmp = (PriorityGroup & (uint32)0x07UL);             /* only values 0..7 are used          */
...
/**
  ...
  \return                Priority grouping field (SCB->AIRCR [10:8] PRIGROUP field).
 */
__STATIC_INLINE uint32 TZ_NVIC_GetPriorityGrouping_NS(void)
{
    return ((uint32)((SCB_NS->AIRCR & SCB_AIRCR_PRIGROUP_Msk) >> SCB_AIRCR_PRIGROUP_Pos));
}
...
__STATIC_INLINE void TZ_NVIC_EnableIRQ_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC_NS->ISER[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
    }
}
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 TZ_NVIC_GetEnableIRQ_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC_NS->ISER[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
...
__STATIC_INLINE void TZ_NVIC_DisableIRQ_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC_NS->ICER[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
    }
}
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 TZ_NVIC_GetPendingIRQ_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC_NS->ISPR[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
...
__STATIC_INLINE void TZ_NVIC_SetPendingIRQ_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC_NS->ISPR[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
    }
}
...
__STATIC_INLINE void TZ_NVIC_ClearPendingIRQ_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC_NS->ICPR[(((uint32)IRQn) >> 5UL)] = (uint32)(1UL << (((uint32)IRQn) & 0x1FUL));
    }
}
...
/**
  ...
  \note    IRQn must not be negative.
 */
__STATIC_INLINE uint32 TZ_NVIC_GetActive_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return ((uint32)(((NVIC_NS->IABR[(((uint32)IRQn) >> 5UL)] & (1UL << (((uint32)IRQn) & 0x1FUL))) != 0UL) ? 1UL : 0UL));
    }
    else
    {
        return (0U);
 ...
 */
__STATIC_INLINE void TZ_NVIC_SetPriority_NS(IRQn_Type IRQn, uint32 priority)
{
    if ((sint32)(IRQn) >= 0)
    {
        NVIC_NS->IPR[((uint32)IRQn)]               = (uint8)((priority << (8U - __NVIC_PRIO_BITS)) & (uint32)0xFFUL);
    }
    else
    {
        SCB_NS->SHPR[(((uint32)IRQn) & 0xFUL) - 4UL] = (uint8)((priority << (8U - __NVIC_PRIO_BITS)) & (uint32)0xFFUL);
    }
}
 ...
 */
__STATIC_INLINE uint32 TZ_NVIC_GetPriority_NS(IRQn_Type IRQn)
{
    if ((sint32)(IRQn) >= 0)
    {
        return (((uint32)NVIC_NS->IPR[((uint32)IRQn)]               >> (8U - __NVIC_PRIO_BITS)));
    }
    else
    {
        return (((uint32)SCB_NS->SHPR[(((uint32)IRQn) & 0xFUL) - 4UL] >> (8U - __NVIC_PRIO_BITS)));
    }
}
#endif /*  defined (__ARM_FEATURE_CMSE) &&(__ARM_FEATURE_CMSE == 3U) */
 ...
 */
__STATIC_INLINE uint32 SCB_GetFPUType(void)
{
    uint32 mvfr0;
    mvfr0 = FPU->MVFR0;
 ...
 */
__STATIC_INLINE void DCB_SetAuthCtrl(uint32 value)
{
    __DSB();
    __ISB();
    DCB->DAUTHCTRL = value;
 ...
 */
__STATIC_INLINE uint32 DCB_GetAuthCtrl(void)
{
...
/**
  ...
  \param [in]  value  value to be writen
 */
__STATIC_INLINE void TZ_DCB_SetAuthCtrl_NS(uint32 value)
{
    __DSB();
    __ISB();
...
/**
  ...
  \return             Debug Authentication Control Register.
 */
__STATIC_INLINE uint32 TZ_DCB_GetAuthCtrl_NS(void)
{
 ...
 */
__STATIC_INLINE uint32 DIB_GetAuthStatus(void)
{
...
/**
  ...
  \return             Debug Authentication Status Register.
 */
__STATIC_INLINE uint32 TZ_DIB_GetAuthStatus_NS(void)
{
 ...
 */
__STATIC_INLINE uint32 SysTick_Config(uint32 ticks)
{
 ...
 */
__STATIC_INLINE uint32 TZ_SysTick_Config_NS(uint32 ticks)
{
    if ((ticks - 1UL) > SysTick_LOAD_RELOAD_Msk)
    {
        return (1UL);                                                         /* Reload value impossible */
    }
    SysTick_NS->LOAD  = (uint32)(ticks - 1UL);                            /* set reload register */
 ...
 */
__STATIC_INLINE sint32 ITM_ReceiveChar(void)
{
 ...
 */
__STATIC_INLINE sint32 ITM_CheckChar(void)
{
    if (ITM_RxBuffer == ITM_RXBUFFER_EMPTY)
    {
        return (0);                              /* no character available */
