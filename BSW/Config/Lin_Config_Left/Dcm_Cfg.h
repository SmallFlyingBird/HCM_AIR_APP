 ...
 * @type:define range:1~65535 note:unit ms
 */
#define DCM_P4MAX_TIME              5000u

/* DCM protocol time :P4 of erase routine service;
 * @type:define range:1~65535 note:unit ms
 */
#define DCM_P4MAX_TIME_ERASE        60000u

/* DCM protocol time :P4 of erase check memory service;
 * @type:define range:1~65535 note:unit ms
 */
#define DCM_P4MAX_TIME_CHECKMEMORY  2000u
...
#define DCM_27_SENDKEY_LENGTH       3u
#define DCM_27_RANDOMMSG_LEN        3u
#else
#define DCM_27_SENDKEY_LENGTH       16u
#define DCM_27_RANDOMMSG_LEN        16u
#endif
...
#define DCM_ROUTINE_CONTROL_NUM     4u
...
#define DCM_DTC_SET_NUM             0u
/** DCM pduId use for LinTp */
...
#define DCM_SECURITY_LEV1              0x1u

/*service 22 maxinum number of DIDs received at a time */
#define DCM_READDID_MAX_NUM         DCM_READDID_NUM
/*******************************************************************************
