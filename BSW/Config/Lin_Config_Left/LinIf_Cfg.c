...
{
    {
        ...
        LINTP_PHY_NAD_TEST,                 /* LinTpRxNSduNad */
...
{
    {
        ...
        LINTP_PHY_NAD_TEST,                 /* LinTpTxNSduNad */
...
// CONST(LinTp_ConfigType, LINIF_CONST) LinTp_PCConfig_M =
// {
//     5,                          /* LinTpMaxNumberOfRespPendingFrames */
//     0,                          /* LinTpMaxRxNSduCnt */
//     2,                          /* LinTpNumOfRxNSdu */
...
//     LINTP_TIME_P2,              /* LinTpP2Timing */
//     LinTp_ChannelConfigData,    /* LinTpChannelConfig */
//     LinTp_RxNSduData_M,           /* LinTpRxNSdu */
//     LinTp_TxNSduData_M            /* LinTpTxNSdu */
// };
