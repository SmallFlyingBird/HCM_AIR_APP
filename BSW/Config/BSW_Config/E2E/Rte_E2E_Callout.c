...
void Rte_COMCbk_igActnOfLedLoBeam(uint8* Lin_SduPtr)
{
    ...
    static uint8 CntErrorCount = 0;
    static uint8 CrcErrorCount = 0;
    ...
    Interface_SetDtcE2EError(E_E2EErrorType_ActnOfLedLoBeam_TimeoutError,0);
...
void Rte_COMCbk_igActvnOfIndcr(uint8* Lin_SduPtr)
{
    ...
    Interface_SetDtcE2EError(E_E2EErrorType_ActvnOfIndcr_TimeoutError,0);
