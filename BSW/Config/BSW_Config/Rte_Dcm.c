...
{/* Primary Bootloader Software Part Number:   1.0.2 */
	0x89, 0x01, 0x24, 0x55, 0x06, 0x31, 0x30 ,0x32
};

static const uint8 Buffer_DcmDspData_0xF1AE[DataLength_DcmDspData_0xF1AE] =
{/* ECU Software Part Numbers - Geely */
	0x02, \
	0x66, 0x08, 0x34, 0x25, 0x62, 0x31, 0x35 ,0x30, \
	0x66, 0x08, 0x34, 0x25, 0x62, 0x31, 0x35 ,0x30/* 1 5 0 */
};
