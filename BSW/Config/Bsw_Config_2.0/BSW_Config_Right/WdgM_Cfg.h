...
#define     WDGM_WATCHDOG_0                            WdgIfExternalDevice_0

#define WDGM_FIRST_EXPIRED_SEID                  0x2001cffcU
#define WDGM_FIRST_EXPIRED_INVERSE_SEID          0x2001cffeU
...
#define SE0_WdgMCheckpoint_Alive_10ms                  0U
