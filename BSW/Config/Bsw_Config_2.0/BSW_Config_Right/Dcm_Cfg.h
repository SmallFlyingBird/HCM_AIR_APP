...
#define  DCM_TEMP_BUFFER_LENGTH                     (100u)
...
#define  DCM_FRAME_LENGTH                           (1024u)

#define DCM_VgmToHcmlDiagDcmIpdu                                    0x0 /*RxPdu Id*/
#define DCM_VgmToAllFuncDiagDcmIpdu                                    0x1 /*RxPdu Id*/

#define DCM_HcmlToVgmDiagDcmIpdu                                    0x0 /*TxPdu Id*/
#define DCM_PDUR_HcmlToVgmDiagDcmIpdu                                PDUR_SRCPDU_HcmlToVgmDiagDcmIpdu
...
#define  DCM_UDS_FUNC_ENABLED                       (STD_ON) /*Enable/Disable UDS Protocol*/
    ...
    #define  DCM_UDS_SERVICE0X27_ENABLED            (STD_OFF) /*SecurityAccess*/
    #define  DCM_UDS_SERVICE0X28_ENABLED            (STD_OFF) /*CommunicationControl*/
    ...
    #define  DCM_UDS_SERVICE0X85_ENABLED            (STD_OFF) /*ControlDTCSetting*/
...
#define  DCM_DSP_DID_FOR_2F_NUM                     (18u)            /*DID for 2F Number*/
#define  DCM_DSP_DATA_FUNC_ENABLED                  (STD_ON)
#define  DCM_DDDID_STORAGE                          (STD_ON)       /*Enable/disable DDDID function*/
#define  DCM_DDDID_STORAGE_BLOCKID                  (Nvm_Block_DCM)               /*DDDid Storage BlockID*/
...
#define  DCM_UDS_SERVICE0X19_01_ENABLED                (STD_OFF)
#define  DCM_UDS_SERVICE0X19_02_ENABLED                (STD_ON)
#define  DCM_UDS_SERVICE0X19_03_ENABLED                (STD_ON)
...
#define  DCM_DSP_ROUTINE_MAX_NUM                    (7u)               /*Number of RoutineID*/
...
#define  DCM_SEED_MAX_SIZE                          (3u)            /*security total number*/
