...
**                                                                            **
**  Created on  : 2024/04/08 10:03:37                                         **
**  Author      : <>                                                          **
**  Vendor      :                                                             **
...
** WdgIfDevice
*/
#define     WdgIfExternalDevice_0            0

#define WdgIf_SetTriggerCondition_Map(timeout)          ExWdg_SetTriggerCondition(timeout)
#define WdgIf_SetMode_Map(mode)                         ExWdg_SetMode(mode)
