...
/** @ref SWS_ComM_01005 */
typedef uint8 ComM_UserHandleSubArrayType_BodyExposedCAN_HCML[1];

/** @ref SWS_ComM_00906 */
typedef struct{

    uint8 numberOfRequesters;
    ComM_UserHandleSubArrayType_BodyExposedCAN_HCML handleArray;
}ComM_UserHandleArrayType_BodyExposedCAN_HCML;
