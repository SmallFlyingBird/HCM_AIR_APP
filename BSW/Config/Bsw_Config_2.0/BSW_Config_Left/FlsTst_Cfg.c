...
CONST( FlsTst_BlockBgndType, FLSTST_CONST) FlsTst_BlockBgnd[FLSTST_BGND_BLOCK_NUM] =
{
    {
        0u,                 /* BgndBlockIndex   */
        0x1009000u,           /* BlockBaseAddress */
        0x1000u,           /* BlcokLength      */
        0x100A000u,            /* SignatureAddress */
        FLSTST_16BIT_CRC,   /* TestAlgorithm    */
    }
};
CONST( FlsTst_BlockFgndType, FLSTST_CONST) FlsTst_BlockFgnd[FLSTST_FGND_BLOCK_NUM] =
{
     {
        0u,                 /* BgndBlockIndex   */
        0x1006000u,           /* BlockBaseAddress */
        0x100u,           /* BlcokLength      */
        0x1006200u,            /* SignatureAddress */
        FLSTST_16BIT_CRC,   /* TestAlgorithm    */
    }
};
