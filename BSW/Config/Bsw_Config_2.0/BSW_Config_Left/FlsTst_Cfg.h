...
#define FLSTST_INIT_ECC                     STD_OFF

/* Time out value of Fgnd test */
#define FLSTST_FGND_TIMEOUT                 0xffffffffU

/*  Enable/Disable the extended safety mechanism. */
#define FLSTST_EXTEND_SAFETY_MODE           STD_OFF
...
#ifndef FLSTST_EXTEND_SAFETY_MODE
#define FLSTST_EXTEND_SAFETY_MODE           STD_OFF
#endif /* #ifndef FLSTST_EXTEND_SAFETY_MODE */

#ifndef FLSTST_DEM_FLSTST_E_FLSTST_FAILURE
#define FLSTST_DEM_FLSTST_E_FLSTST_FAILURE  STD_OFF
#endif /* #ifndef FLSTST_EXTEND_SAFETY_MODE */
