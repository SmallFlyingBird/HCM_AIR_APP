...
static VAR(Os_TaskType, OS_VAR) Os_ActivateQueue_Core0_8[3];
static VAR(Os_TaskType, OS_VAR) Os_ActivateQueue_Core0_9[3];
...
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_100ms_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_10ms_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_1ms_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_1s_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_20ms_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_2ms_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_50ms_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
...
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_OsTask_Init_Stack[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
...
CONST(Os_StackType, OS_CONST) Os_TaskStackCore0[CFG_TASK_MAX_CORE0] =
{
    ...
    {OS_STACK_TOP(Os_OsTask_20ms_Stack), OS_STACK_BOTTOM(Os_OsTask_20ms_Stack)},
...
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_ADC0_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_ADC1_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_BUSOFF_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_ECC_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_ERROR_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_MSG_0_31_IRQn_Stack_Core0[2048];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_MSG_32_63_IRQn_Stack_Core0[2048];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_MSG_64_95_IRQn_Stack_Core0[2048];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_MSG_96_127_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_RX_WARNING_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_SELF_WKUP_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CAN6_TX_WARNING_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CMU0_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CMU1_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_CMU2_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_MCPWM0_CH_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_MCPWM1_CH_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_SERU_CHANNEL_ERR_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_SERU_PARITY_ERR_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_STIM_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_TIM0_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
#define OS_START_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
static VAR(Os_StackDataType, OS_VAR) Os_TIM1_IRQn_Stack_Core0[1024];
#define OS_STOP_SEC_VAR_STACK_CORE0
#include "Os_MemMap.h"
...
CONST(Os_StackType, OS_CONST) Os_ISR2StackCore0[CFG_ISR2_MAX_CORE0] =
{
    ...
    {OS_STACK_TOP(Os_ADC0_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_ADC0_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_ADC1_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_ADC1_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_BUSOFF_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_BUSOFF_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_ECC_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_ECC_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_ERROR_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_ERROR_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_MSG_0_31_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_MSG_0_31_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_MSG_32_63_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_MSG_32_63_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_MSG_64_95_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_MSG_64_95_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_MSG_96_127_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_MSG_96_127_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_RX_WARNING_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_RX_WARNING_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_SELF_WKUP_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_SELF_WKUP_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CAN6_TX_WARNING_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CAN6_TX_WARNING_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CMU0_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CMU0_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CMU1_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CMU1_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_CMU2_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_CMU2_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_MCPWM0_CH_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_MCPWM0_CH_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_MCPWM1_CH_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_MCPWM1_CH_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_SERU_CHANNEL_ERR_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_SERU_CHANNEL_ERR_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_SERU_PARITY_ERR_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_SERU_PARITY_ERR_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_STIM_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_STIM_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_TIM0_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_TIM0_IRQn_Stack_Core0)},
    {OS_STACK_TOP(Os_TIM1_IRQn_Stack_Core0), OS_STACK_BOTTOM(Os_TIM1_IRQn_Stack_Core0)},
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "Os_MemMap.h"
...
CONST(Os_TaskCfgType, OS_CONST) Os_TaskCfgCore0[CFG_TASK_MAX_CORE0] =
{
    ...
    {
        &Os_TaskEntry_OsTask_20ms,      /*osTaskEntry*/
        Os_GetObjLocalId(OsTask_20ms),   /*osTaskStackId*/
        1,                              /*osTaskActivation*/
        5,                              /*osTaskPriority*/
        OS_PREEMPTIVE_FULL,             /*osTaskSchedule*/
        0U,                             /*osRsv1*/
...
CONST(uint16, OS_CONST) Os_ResourceAccessMask_OsTask_1s[1] =
{

    0x1U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_OsTask_20ms[1] =
{
...
P2CONST(uint16, OS_VAR, OS_CONST) Os_TaskResourceAccessMaskCore0[CFG_TASK_MAX_CORE0] =
{
    ...
    Os_ResourceAccessMask_OsTask_20ms,
...
FUNC(void, OS_CODE) AlarmCallback_OsAlarm_1s(void)
{
    (void)ActivateTask(OsTask_1s);
}
FUNC(void, OS_CODE) AlarmCallback_OsAlarm_20ms(void)
{
    (void)ActivateTask(OsTask_20ms);
}
...
CONST(Os_AlarmCfgType, OS_CONST) Os_AlarmCfgCore0[CFG_ALARM_MAX_CORE0] =
{
    ...
    },
    {
        Os_GetObjLocalId(SystemTimer_Core0),  /*osAlarmCounter*/
        NULL_PTR,   /*osAlarmAutostartRef*/
        &AlarmCallback_OsAlarm_20ms,    /*osAlarmCallback*/
    },
    {
        Os_GetObjLocalId(SystemTimer_Core0),  /*osAlarmCounter*/
        NULL_PTR,   /*osAlarmAutostartRef*/
...
CONST(uint16, OS_CONST) Os_ResourceAccessMask_SysTick_n[1] =
{
    0x1U
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_ADC0_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_ADC1_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_BUSOFF_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_ECC_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_ERROR_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_MSG_0_31_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_MSG_32_63_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_MSG_64_95_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_MSG_96_127_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_RX_WARNING_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_SELF_WKUP_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CAN6_TX_WARNING_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CMU0_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CMU1_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_CMU2_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_MCPWM0_CH_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_MCPWM1_CH_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_SERU_CHANNEL_ERR_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_SERU_PARITY_ERR_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_STIM_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_TIM0_IRQn[1] =
{

    0x0U,
};
CONST(uint16, OS_CONST) Os_ResourceAccessMask_TIM1_IRQn[1] =
{
...
{
    Os_ResourceAccessMask_SysTick_n,
    Os_ResourceAccessMask_ADC0_IRQn,
    Os_ResourceAccessMask_ADC1_IRQn,
    Os_ResourceAccessMask_CAN6_BUSOFF_IRQn,
    Os_ResourceAccessMask_CAN6_ECC_IRQn,
    Os_ResourceAccessMask_CAN6_ERROR_IRQn,
    Os_ResourceAccessMask_CAN6_MSG_0_31_IRQn,
    Os_ResourceAccessMask_CAN6_MSG_32_63_IRQn,
    Os_ResourceAccessMask_CAN6_MSG_64_95_IRQn,
    Os_ResourceAccessMask_CAN6_MSG_96_127_IRQn,
    Os_ResourceAccessMask_CAN6_RX_WARNING_IRQn,
    Os_ResourceAccessMask_CAN6_SELF_WKUP_IRQn,
    Os_ResourceAccessMask_CAN6_TX_WARNING_IRQn,
    Os_ResourceAccessMask_CMU0_IRQn,
    Os_ResourceAccessMask_CMU1_IRQn,
    Os_ResourceAccessMask_CMU2_IRQn,
    Os_ResourceAccessMask_MCPWM0_CH_IRQn,
    Os_ResourceAccessMask_MCPWM1_CH_IRQn,
    Os_ResourceAccessMask_SERU_CHANNEL_ERR_IRQn,
    Os_ResourceAccessMask_SERU_PARITY_ERR_IRQn,
    Os_ResourceAccessMask_STIM_IRQn,
    Os_ResourceAccessMask_TIM0_IRQn,
    Os_ResourceAccessMask_TIM1_IRQn,
};
#define OS_STOP_SEC_CONST_UNSPECIFIED
#include "Os_MemMap.h"
