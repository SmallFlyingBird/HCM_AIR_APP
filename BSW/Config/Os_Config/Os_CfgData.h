...
#define OS_START_SEC_CODE
#include "Os_MemMap.h"
DeclareISR(ISR_OS_ADC0_IRQn);
DeclareISR(ISR_OS_ADC1_IRQn);
DeclareISR(ISR_OS_CAN6_BUSOFF_IRQn);
DeclareISR(ISR_OS_CAN6_ECC_IRQn);
DeclareISR(ISR_OS_CAN6_ERROR_IRQn);
DeclareISR(ISR_OS_CAN6_MSG_0_31_IRQn);
DeclareISR(ISR_OS_CAN6_MSG_32_63_IRQn);
DeclareISR(ISR_OS_CAN6_MSG_64_95_IRQn);
DeclareISR(ISR_OS_CAN6_MSG_96_127_IRQn);
DeclareISR(ISR_OS_CAN6_RX_WARNING_IRQn);
DeclareISR(ISR_OS_CAN6_SELF_WKUP_IRQn);
DeclareISR(ISR_OS_CAN6_TX_WARNING_IRQn);
DeclareISR(ISR_OS_CMU0_IRQn);
DeclareISR(ISR_OS_CMU1_IRQn);
DeclareISR(ISR_OS_CMU2_IRQn);
DeclareISR(ISR_OS_DMA_CH12_TX_COMPLETE_IRQn);
DeclareISR(ISR_OS_DMA_CH13_TX_COMPLETE_IRQn);
DeclareISR(ISR_OS_MCPWM0_CH_IRQn);
DeclareISR(ISR_OS_MCPWM1_CH_IRQn);
DeclareISR(ISR_OS_SERU_CHANNEL_ERR_IRQn);
DeclareISR(ISR_OS_SERU_PARITY_ERR_IRQn);
DeclareISR(ISR_OS_STIM_IRQn);
DeclareISR(ISR_OS_TIM0_IRQn);
DeclareISR(ISR_OS_TIM1_IRQn);
#define OS_STOP_SEC_CODE
#include "Os_MemMap.h"
