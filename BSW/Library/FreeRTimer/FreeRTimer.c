...
uint32 Frt_CalculateElapsedMS(uint32 OldCurMs)
{
    ...
    case OS_CORE_ID_1: {
        ...
        (void)GetElapsedCounterValue(SystemTimer_Core1, &OldCurMs, &ElapsedMs);
    ...
    case OS_CORE_ID_2: {
        ...
        (void)GetElapsedCounterValue(SystemTimer_Core2, &OldCurMs, &ElapsedMs);
...
uint32 Frt_CalculateElapsedUS(uint32 OldCurUs)
{
    ...
    case OS_CORE_ID_1: {
        ...
        (void)GetElapsedCounterValue(SystemTimer_Core1, &OldCurUs, &ElapsedUs);
    ...
    case OS_CORE_ID_2: {
        ...
        (void)GetElapsedCounterValue(SystemTimer_Core2, &OldCurUs, &ElapsedUs);
