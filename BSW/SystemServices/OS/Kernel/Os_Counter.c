...
#if (CFG_COUNTER_MAX_CORE1 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 1:
...
#if (CFG_COUNTER_MAX_CORE2 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 2:
...
#if (CFG_COUNTER_MAX_CORE3 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 3:
...
#if (CFG_COUNTER_MAX_CORE4 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 4:
...
#if (CFG_COUNTER_MAX_CORE5 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 5:
...
/* Schedule table. */
    ...
    OS_INCC_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* Cross core use shall be supported. */
    ...
    OS_GCV_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* Cross core use shall be supported. */
    ...
    OS_GECV_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
