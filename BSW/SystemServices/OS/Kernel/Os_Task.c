...
#if (CFG_TASK_MAX_CORE3 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 3:
        if (Os_GetObjLocalId(TaskID) >= CFG_TASK_MAX_CORE3)
        {
#if (TRUE == CFG_ERRORHOOK)
            OSError_Save_ServiceId(OSServiceId_ActivateTask);
            OSError_Save_ActivateTask(TaskID);
...
#if (CFG_TASK_MAX_CORE4 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 4:
        if (Os_GetObjLocalId(TaskID) >= CFG_TASK_MAX_CORE4)
        {
#if (TRUE == CFG_ERRORHOOK)
            OSError_Save_ServiceId(OSServiceId_ActivateTask);
            OSError_Save_ActivateTask(TaskID);
...
#if (CFG_TASK_MAX_CORE5 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 5:
        if (Os_GetObjLocalId(TaskID) >= CFG_TASK_MAX_CORE5)
        {
#if (TRUE == CFG_ERRORHOOK)
            OSError_Save_ServiceId(OSServiceId_ActivateTask);
            OSError_Save_ActivateTask(TaskID);
...
/* Basic Status */
    ...
    OS_AT_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return Status;
}
...
/* Timing protection: reset task exe time. */
    ...
    OS_TT_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return Status;
}
...
/* Timing protection: Check inter-arrival time. */
    ...
    OS_CT_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return Status;
}
...
/* Basic Status */
    ...
    OS_SCHEDULE_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return Status;
}
...
FUNC(StatusType, OS_CODE) GetTaskID(TaskRefType TaskID)
{
    ...
    OS_GTI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
...
/* Extended Status */
    ...
    OS_GTS_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return Status;
}
