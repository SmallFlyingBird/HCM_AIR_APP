...
/* Timing protection: Check inter-arrival time. */
    ...
    OS_SE_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* Timing protection: reset task exe time. OS473. */
    ...
    OS_WE_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* Extended Status */
    ...
    OS_GE_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
FUNC(StatusType, OS_CODE) ClearEvent(EventMaskType Mask)
{
    ...
    OS_CE_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
