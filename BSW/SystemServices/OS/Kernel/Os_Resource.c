...
#define OS_START_SEC_VAR_CLONE
#include "Os_MemMap.h"
static VAR(uint16, OS_VAR) Os_CfgStdResourceMax = 0U;
#define OS_STOP_SEC_VAR_CLONE
#include "Os_MemMap.h"
...
FUNC(void, OS_CODE) Os_InitResource(void)
{
    ...
    case 3:
        ...
        for (i = 0U; i < CFG_STD_RESOURCE_MAX_CORE3; i++)
        {
    ...
    case 4:
        ...
        for (i = 0U; i < CFG_STD_RESOURCE_MAX_CORE4; i++)
        {
    ...
    case 5:
        ...
        for (i = 0U; i < CFG_STD_RESOURCE_MAX_CORE5; i++)
        {
...
/* AutoSar SC2: Timing protection, resource lock. */
    ...
    OS_GR_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/*res and spinlock should together release as LIFO order*/
    ...
    OS_RR_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
