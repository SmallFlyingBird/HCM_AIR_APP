...
#if (CFG_ISR_MAX_CORE1 > 0) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 1:
...
#if (CFG_ISR_MAX_CORE2 > 0) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 2:
...
#if (CFG_ISR_MAX_CORE3 > 0) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 3:
...
#if (CFG_ISR_MAX_CORE4 > 0) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 4:
...
#if (CFG_ISR_MAX_CORE5 > 0) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 5:
...
FUNC(void, OS_CODE) DisableAllInterrupts(void)
{
    ...
    /* PRQA S 1843,3415++ */ /* MISRA Rule 10.4,13.5 */
...
/* Timing protection: resource lock. */
    ...
    OS_DAI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
}
...
/* AutoSar SC2: Timing protection, resource lock. */
    ...
    OS_EAI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
}
...
/* AutoSar SC2: Timing protection, resource lock. */
    ...
    OS_RAI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
}
...
/* AutoSar SC2: Timing protection, resource lock. */
    ...
    OS_SAI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
}
...
/* AutoSar SC2: Timing protection, resource lock. */
    ...
    OS_ROI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
}
...
/* AutoSar SC2: Timing protection, resource lock. */
    ...
    OS_SOI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
}
...
/* OS263. */
    ...
    OS_GII_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return osRet;
}
 ...
 */
/******************************************************************************/
FUNC(void, OS_CODE) Os_SpinlockResumeOsIsr(void)
{
    Os_SuspendOsCount = Os_SuspendOsCount - 1u;                    /*Os_SuspendOsCount--*/
    if (0U == Os_SuspendOsCount)
    {
 ...
 */
/******************************************************************************/
FUNC(void, OS_CODE) Os_SpinlockSuspendOsIsr(void)
{
    OS_ARCH_DECLARE_CRITICAL();
    if (0U == Os_SuspendOsCount)
    {
