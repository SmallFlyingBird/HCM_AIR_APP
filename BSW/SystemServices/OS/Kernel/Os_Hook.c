 ...
 */
/********************************************************************/
static FUNC(void, OS_CODE) Os_ProtHookTerminateIsrC2(StatusType osErrType) /* PRQA S 3006 */ /* MISRA Dir 4.3 */
{
#if (CFG_STD_RESOURCE_MAX > 0U)
    uint16 i;
    Os_CoreIdType Core_Id;
...
/* PRQA S 0404-- */     /* MISRA Rule 1.3,13.2 */
    ...
    if(HardFault_Flag == 1) /* PRQA S 1863 */ /* MISRA Rule 10.4 */
    {
...
/* OESK 8.2:
   ...
   resources following the LIFO principle (stack like). */
    ...
    {
        /* PRQA S 0303,0306,1840,1842,2741,1862,1860,2742,3430,4542,1841,3432++ */ /* MISRA Rule 10.4,14.3,20.7,10.1 */
    ...
    if (E_OS_STACKFAULT != osErrType)
    {
        ...
        OS_ARCH_ISR2_EPILOGUE_TERMINATEISR();
        /* PRQA S 3415,3335,0306,3200,2981-- */ /* MISRA Rule 13.5,17.3,11.4,17.7,2.2 */
    }
#endif /* TRUE == CFG_TIMING_PROTECTION_ENABLE */
