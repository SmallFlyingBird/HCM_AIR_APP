...
#if (CFG_ALARM_MAX_CORE1 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 1:
...
#if (CFG_ALARM_MAX_CORE2 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 2:
...
#if (CFG_ALARM_MAX_CORE3 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 3:
...
#if (CFG_ALARM_MAX_CORE4 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 4:
...
#if (CFG_ALARM_MAX_CORE5 > 0U) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 5:
 ...
 * ALARM that is bound to another core. */
    ...
    OS_GA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
 ...
 * ALARM that is bound to another core. */
    ...
    OS_GAB_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
 ...
 * ALARM that is bound to another core. */
    ...
    OS_CA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
 ...
 * ALARM that is bound to another core. */
    ...
    OS_SRA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
 ...
 * ALARM that is bound to another core. */
    ...
    OS_SAA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
