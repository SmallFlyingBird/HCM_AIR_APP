...
#if (TRUE == CFG_CORE1_AUTOSAROS_ENABLE) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (TRUE == CFG_CORE2_AUTOSAROS_ENABLE) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (TRUE == CFG_CORE3_AUTOSAROS_ENABLE) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (TRUE == CFG_CORE4_AUTOSAROS_ENABLE) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (TRUE == CFG_CORE5_AUTOSAROS_ENABLE) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
extern P2VAR(TrustedFunctionIndexType, AUTOMATIC, OS_VAR) Os_TrustedFuncNestQueue;/* PRQA S 3432 */ /* MISRA Rule 20.7 */
...
#if (CFG_STD_RESOURCE_MAX_CORE1 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_STD_RESOURCE_MAX_CORE2 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_STD_RESOURCE_MAX_CORE3 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_STD_RESOURCE_MAX_CORE4 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_STD_RESOURCE_MAX_CORE5 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_TRUSTED_SYSTEM_SERVICE_MAX_CORE1 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_TRUSTED_SYSTEM_SERVICE_MAX_CORE2 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_TRUSTED_SYSTEM_SERVICE_MAX_CORE3 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_TRUSTED_SYSTEM_SERVICE_MAX_CORE4 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if (CFG_TRUSTED_SYSTEM_SERVICE_MAX_CORE5 > 0U)  /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE1) && (CFG_TASK_MAX_CORE1 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE2) && (CFG_TASK_MAX_CORE2 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE3) && (CFG_TASK_MAX_CORE3 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE4) && (CFG_TASK_MAX_CORE4 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE5) && (CFG_TASK_MAX_CORE5 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE1) && (CFG_ISR_MAX_CORE1 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE2) && (CFG_ISR_MAX_CORE2 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE3) && (CFG_ISR_MAX_CORE3 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE4) && (CFG_ISR_MAX_CORE4 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
#if ((TRUE == CFG_TIMING_PROTECTION_ENABLE_CORE5) && (CFG_ISR_MAX_CORE5 > 0U)) /* PRQA S 3332 */ /* MISRA Rule 20.9 */
...
extern FUNC(boolean, OS_CODE) Os_AddressWritable(P2VAR(uint8, AUTOMATIC, OS_VAR) Address); /* PRQA S 3432 */ /* MISRA Rule 20.7 */
/* PRQA S 3432 */ /* MISRA Rule 20.7 */
