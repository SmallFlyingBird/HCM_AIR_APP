...
/*OS261: return the identifier to which the executing Task/ISR/hook was configured*/
    ...
    OS_GAI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return ApplID;
}
...
/*service protection*/
    ...
    OS_GCAI_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return ApplID;
}
...
FUNC(StatusType, OS_CODE) AllowAccess(void)
{
    ...
    OS_AAS_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
    ...
    (ApplicationType Application, ApplicationStateRefType Value)
{
    ...
    OS_GAS_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
 ...
 * RES_SCHEDULER , return ACCESS */
    ...
    OS_COA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
...
CheckObjectOwnership(ObjectTypeType ObjectType, AppObjectId ObjectID)
{
 ...
 * RES_SCHEDULER , return ACCESS */
    ...
    OS_COO_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return ApplID;
}
...
/* OS447: Disable the interrupt source of the OsIsrs owned by the application */
    ...
    OS_TA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
