...
#if (CFG_SCHEDTBL_MAX_CORE1 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 1:
...
#if (CFG_SCHEDTBL_MAX_CORE2 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 2:
...
#if (CFG_SCHEDTBL_MAX_CORE3 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 3:
...
#if (CFG_SCHEDTBL_MAX_CORE4 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 4:
...
#if (CFG_SCHEDTBL_MAX_CORE5 > 0U)/* PRQA S 3332 */ /* MISRA Rule 20.9 */
    case 5:
...
/* OS293 */
    ...
    OS_GSTS_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* OS332 + OS276 */
    ...
    OS_SSTR_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* OS349 */
    ...
    OS_SSTA_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* OS279 */
    ...
    OS_SST_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
 ...
 * NextScheduleTable() shall return E_OS_ID.*/
    ...
    OS_NST_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* OS387 */
    ...
    OS_SSTS_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
...
/* OS456. */
    ...
    OS_SYNCST_EXIT(); /* PRQA S 1842 */ /* MISRA Rule 10.4 */
    return OsReturnErr;
}
