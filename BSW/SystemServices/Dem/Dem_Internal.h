...
#define DEM_START_SEC_CODE
#include "Dem_MemMap.h"
static inline FUNC(void, DEM_CODE) Dem_UpdateInternalData(uint16 IntId)
{
    ...
    if (DTCRef != DEM_DTC_REF_INVALID)
    {
        ...
        FDCInfoType* pFDCInfo = &FDCInfo[DTCRef];
