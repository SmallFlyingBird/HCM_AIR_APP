...
#define Z20K148M_H_VENDOR_ID                   0x00B3U
#define Z20K148M_H_AR_RELEASE_MAJOR_VERSION    4U
#define Z20K148M_H_AR_RELEASE_MINOR_VERSION    6U
#define Z20K148M_H_AR_RELEASE_REVISION_VERSION 0U
#define Z20K148M_H_SW_MAJOR_VERSION            1U
#define Z20K148M_H_SW_MINOR_VERSION            2U
#define Z20K148M_H_SW_PATCH_VERSION            1U

#ifdef INTER_MODULE_ASR_CHECK_ENABLE
    #if ((Z20K148M_H_AR_RELEASE_MAJOR_VERSION != PLATFORM_TYPES_AR_RELEASE_MAJOR_VERSION) ||       \
         (Z20K148M_H_AR_RELEASE_MINOR_VERSION != PLATFORM_TYPES_AR_RELEASE_MINOR_VERSION))
        #error "AUTOSAR Version of Z20K148M.h and Platform_Types.h and are different"
    #endif
#endif
...
#define FLASH_CODE_END_ADDR  ((uint32)0x001FFFFFU) /*!< program/Code flash end address */
...
#define SRAML_BASE_ADDR      ((uint32)0x1FFE0000U) /*!< SRAML base address */
#define SRAML_END_ADDR       ((uint32)0x1FFFFFFFU) /*!< SRAML end address */
#define SRAMU_BASE_ADDR      ((uint32)0x20000000U) /*!< SRAMU base address */
#define SRAMU_END_ADDR       ((uint32)0x2001FFFFU) /*!< SRAMU end address */
