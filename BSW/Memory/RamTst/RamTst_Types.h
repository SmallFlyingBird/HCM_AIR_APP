...
typedef struct 
{
    ...
    RamTst_BlockTestUseMethod BlockTestUseMethodUse;           /* Block use foreground test or background test  0:foreground  1:background   2:both */
...
typedef struct 
{
    ...
    RamTst_BlockTestUseMethod BlockTestUseMethod;           /* Block use foreground test or background test  0：initial 1:foreground  2:background   3:both */
}RamTst_BlockParams;

typedef struct 
{
    RamTst_AlgorithmType RamTstAlgorithm;                           /* This is the algorithm for which this RamTstAlgParams set is defined.  */
    RamTst_AlgParamsIdType RamTstAlgParamsId;                       /* This is the identifier by which this RamTstAlgParams set can be selected  1 ~ 255*/
    ...
    RamTst_BlockParams* RamTstBlockParams;
}RamTst_AlgParams;
...
typedef struct 
{
    ...
    RamTst_AlgParams* RamTstAlgParams;
