...
typedef SecM_StatusType (*Dcm_GenerateSeedFct)(uint8 *randomMsgOutput, uint32 randomMsgOutputLength);

/** compare key function type */
typedef SecM_StatusType (*Dcm_CompareKeyFct)(uint8* signature, uint32 signatureLength, uint8* randomMsgInput, uint32 randomMsgInputLength);
