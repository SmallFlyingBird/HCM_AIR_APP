...
#define CANTP_RXCHANNEL(ChannelId) (&CanTp_Channels[ChannelId].RxConnection)
/* get the Tx specific channel */
#define CANTP_TXCHANNEL(ChannelId) (&CanTp_Channels[ChannelId].TxConnection)
/* get the Tx specific channel Connection */
#define CANTP_TXSUBCHANNEL(ChannelId) (&CANTP_TXCHANNEL(ChannelId)->Connection)
