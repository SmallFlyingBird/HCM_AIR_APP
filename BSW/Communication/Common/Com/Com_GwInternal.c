...
#endif
    Com_SignalPackInfoType PackParameter;
    boolean notArrSigIsTrue;

#if (STD_ON == COM_GW_DEST_SIG_UPDATE_BIT_ENABLE)
    updateBitPosition = COM_UNUSED_UINT32;
#endif /* (STD_ON == COM_GW_DEST_SIG_UPDATE_BIT_ENABLE) */
...
#endif /* #if (0u < COM_TMCTXSIGNAL_NUMBER) && (STD_ON == COM_TMS_ENABLE) */
        PackParameter.IpduBufferIndex = Com_ConfigStd->ComTxIPdu[txPduId].ComTxIPduBufIndex;
...
/*pack the new value*/
            ...
            Com_TxSignalPackHandle(&PackParameter, sourceSignalValue);
#endif
        }
#if (STD_ON == COM_GW_DEST_SIG_UPDATE_BIT_ENABLE)
