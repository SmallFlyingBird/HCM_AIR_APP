...
#define COM_H_SW_PATCH_VERSION    8u
...
extern VAR(uint16, COM_VAR) Com_RxSignalTimeOutCnt[COM_RXSIGNAL_NUMBER];
#endif

#if (COM_RXSIGNALGROUP_NUMBER > 0u)
extern VAR(uint16, COM_VAR) Com_RxSignalGroupTimeOutCnt[COM_RXSIGNALGROUP_NUMBER];
#endif
