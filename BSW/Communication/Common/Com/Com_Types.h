...
typedef struct
{
    ...
    Com_SignalGroupIdType ComIPduSignalGroupsTimeoutRefNumber;
    P2CONST(Com_SignalGroupIdType, AUTOMATIC, COM_APPL_CONST) ComIPduSignalGroupsTimeoutRef;
    Com_SignalIdType ComIPduSignalsRefNumber;
    P2CONST(Com_SignalIdType, AUTOMATIC, COM_APPL_CONST) ComIPduSignalsRef;
    Com_SignalIdType ComIPduSignalsTimeoutRefNumber;
    P2CONST(Com_SignalIdType, AUTOMATIC, COM_APPL_CONST) ComIPduSignalsTimeoutRef;
