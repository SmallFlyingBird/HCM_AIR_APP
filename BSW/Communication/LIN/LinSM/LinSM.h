...
#define LINSM_H_AR_RELEASE_MINOR_VERSION    2
#define LINSM_H_AR_RELEASE_REVISION_VERSION 2
 ...
 */
/******************************************************************************/
extern FUNC(Std_ReturnType, LINSM_CODE)
...
#define LinSM_GetVersionInfo(VersionInfo) \
    do{\
        ...
        { \
            Det_ReportError(LINSM_MODULE_ID, LINSM_INSTANCE_ID,\
