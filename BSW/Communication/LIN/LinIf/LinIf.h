...
#define LINIF_H_AR_RELEASE_MINOR_VERSION    2U
#define LINIF_H_AR_RELEASE_REVISION_VERSION 2U

#define LINIF_H_SW_MAJOR_VERSION            2U
#define LINIF_H_SW_MINOR_VERSION            0U
#define LINIF_H_SW_PATCH_VERSION            1U
    ...
    do{ \
        ...
        { \
            Det_ReportError(LINIF_MODULE_ID, LINIF_INSTANCE_ID, \
                    LINIF_GETVERSIONINFO_ID, LINIF_E_PARAM_POINTER); \
        } else { \
 ...
 */
/******************************************************************************/
extern FUNC(void, LINIF_CODE)
LinIf_MainFunction(void);
