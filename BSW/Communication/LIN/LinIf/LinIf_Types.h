...
#define LINIF_TYPES_H_AR_RELEASE_MINOR_VERSION      2
#define LINIF_TYPES_H_AR_RELEASE_REVISION_VERSION   2
...
typedef struct
{
    P2FUNC(void,LINIF_APPL_CODE,LinIfTxConfirmationUL)(PduIdType TxPduId);
