...
#define LINTP_C_SW_PATCH_VERSION                0U
...
static FUNC(P2CONST(LinTp_RxNSduType, AUTOMATIC, LINIF_APPL_CONST), LINIF_CODE)
LinTp_GetRxNSdu(PduIdType rxSduId);

static FUNC(LinIf_NodeTypeType, LINIF_CODE) LinTp_GetNodeType(
...
)
{
    ...
    #endif /* #if (LINIF_DEV_ERROR_DETECT == STD_ON) */
    {
        LinIf_NodeTypeType nodeType =
                                LinTp_GetNodeType(tx->LinTpTxNSduChannelRef);
