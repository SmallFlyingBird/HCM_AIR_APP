...
#define LINTP_GET_CHANNEL_CONFIG(idx)       \
            (LinTp_ConfigPtr->LinTpChannelConfig[idx])
#define LINIF_GET_MAX_NUM_PENDING_FRAMES    \
            (LinTp_ConfigPtr->LinTpMaxNumberOfRespPendingFrames)        
