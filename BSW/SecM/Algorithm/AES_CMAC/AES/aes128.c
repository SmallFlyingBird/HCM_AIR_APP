...
Std_ReturnType internal_aes_encrypt( Crypto_AESData *ctx,
                                  const uint8 input[16],
                                  uint8 output[16] );
Std_ReturnType internal_aes_decrypt( Crypto_AESData *ctx,
                                  const uint8 input[16],
                                  uint8 output[16] );
                                  ...
                                  uint8 output[16])
{
    ...
    X0 = *RK++ ^ \
          ((uint32)RSb[(Y0      )& 0xFF ]      )^
          ((uint32)RSb[(Y3 >>  8)& 0xFF ] <<  8)^
          ((uint32)RSb[(Y2 >> 16)& 0xFF ] << 16)^
          ((uint32)RSb[(Y1 >> 24)& 0xFF ] << 24);

    X1 = *RK++ ^ \
          ((uint32)RSb[(Y1      )& 0xFF ]      )^
          ((uint32)RSb[(Y0 >>  8)& 0xFF ] <<  8)^
          ((uint32)RSb[(Y3 >> 16)& 0xFF ] << 16)^
          ((uint32)RSb[(Y2 >> 24)& 0xFF ] << 24);

    X2 = *RK++ ^ \
          ((uint32)RSb[(Y2      )& 0xFF ]      )^
          ((uint32)RSb[(Y1 >>  8)& 0xFF ] <<  8)^
          ((uint32)RSb[(Y0 >> 16)& 0xFF ] << 16)^
          ((uint32)RSb[(Y3 >> 24)& 0xFF ] << 24);

    X3 = *RK++ ^ \
          ((uint32)RSb[(Y3      )& 0xFF ]      )^
          ((uint32)RSb[(Y2 >>  8)& 0xFF ] <<  8)^
          ((uint32)RSb[(Y1 >> 16)& 0xFF ] << 16)^
          ((uint32)RSb[(Y0 >> 24)& 0xFF ] << 24);
...
Std_ReturnType Crypto_AESDecryptCBC(uint8* key,uint8 buf[64],
        uint8 iv[16],uint8 inputlength)
{
    Crypto_AESData ctx;
    Std_ReturnType ret = E_NOT_OK;
